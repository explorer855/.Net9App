...
/// <summary>
/// Extension class to add MassTransit-RabbitMQ configuration to the Host ApplicationBuilder
/// </summary>
public static class AddMassTransit
{
    ...
    public static IServiceCollection AddMassTransitExtension(this HostApplicationBuilder? builder)
    {
